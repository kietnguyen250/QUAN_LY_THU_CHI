...
import static com.kietnt.mob202_asm.TabFragment.Tab_Khoanthu.khoanThuAdapter;
import static com.kietnt.mob202_asm.TabFragment.Tab_Khoanthu.rv_thu;

public class Bottom_sheet_edit_GD_thu extends BottomSheetDialogFragment {
    ...
    //int MaGD;
    public Bottom_sheet_edit_GD_thu(){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.bottom_sheet_giaodich_edit_thu, container, false);
        edt_tieuDe_edit = view.findViewById(R.id.edt_tieuDe_edit_thu);
        edt_ngay_edit = view.findViewById(R.id.edt_ngay_edit_thu);
        edt_tien_edit = view.findViewById(R.id.edt_tien_edit_thu);
        edt_moTa_edit = view.findViewById(R.id.edt_moTa_edit_thu);
        tv_trangthai = view.findViewById(R.id.tv_trangthai_edit);
        sp_thu_edit = view.findViewById(R.id.sp_thu_edit);
        btn_Edit_thu = view.findViewById(R.id.btn_Edit_thu);
        ...
        ds_loai_thu = giaoDich_dao.get_Thu_chi("Thu");
    ...
    public void capnhatThu(){
        ds_giaodich = giaoDich_dao.readAll("Thu");
        khoanThuAdapter = new KhoanThuAdapter(ds_giaodich, getContext());
