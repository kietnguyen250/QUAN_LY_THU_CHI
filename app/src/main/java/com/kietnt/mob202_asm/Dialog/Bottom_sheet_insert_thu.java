...
public class Bottom_sheet_insert_thu extends BottomSheetDialogFragment {
    ...
    public Bottom_sheet_insert_thu(){
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.bottom_sheet_gd_thu, container, false);
        ...
        sp_giaoDich = view.findViewById(R.id.sp_thu);
        tv_trangthai = view.findViewById(R.id.tv_trangthai);
        btn_them_GD = view.findViewById(R.id.btn_Add_GD);
