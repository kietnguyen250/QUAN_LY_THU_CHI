...
import com.kietnt.mob202_asm.Dialog.Bottom_sheet_edit_GD_thu;
...
public class KhoanThuAdapter extends RecyclerView.Adapter<KhoanThuAdapter.MyViewHolder> {
    ...
    public KhoanThuAdapter(ArrayList<GiaoDich> ds_thu, Context context) {
        this.ds_thu = ds_thu;
    ...
    @NonNull
    @Override
    public KhoanThuAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
...
//                final String trangthai = giaoDich_dao.getTrangthai(ds_thu.get(position).getMaLoai(), ds_thu.get(position).getMaGD());
        ...
        holder.iv_sua_thu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Bottom_sheet_edit_GD_thu bottom_sheet_edit_gd = new Bottom_sheet_edit_GD_thu();
    ...
    public void capnhat(){
        ds_thu = giaoDich_dao.readAll("Thu");
        khoanThuAdapter = new KhoanThuAdapter(ds_thu, context);
