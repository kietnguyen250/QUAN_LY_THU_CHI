...
public class Fragment_thongke_chi extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ds_tk_thu = giaoDich_dao.readAll("Chi");
    ...
    private void Date2(){
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(getContext(), new DatePickerDialog.OnDateSetListener(){
            ...
            public void onDateSet(DatePicker view, int i, int i1, int i2) {
                ...
                ds_tk_thus = giaoDich_dao.get_Tk_Chi(btn_date1.getText().toString(), btn_date2.getText().toString());
                tk_thu_adapter = new Tk_Thu_Adapter(ds_tk_thus, getContext());
                rv_tk_thu.setAdapter(tk_thu_adapter);

                String date1 = btn_date1.getText().toString();
                DecimalFormat formatter = new DecimalFormat("#,###");
                double total_2 = giaoDich_dao.getTotalchibyDate(date1, simpleDateFormat.format(calendar1.getTime()));
